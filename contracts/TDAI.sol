...
contract TDAI is IERC20
{
    using SafeMath for uint256;
    string  public constant name = "TDAI Token";
    string  public constant symbol = "TDAI";
    uint256 override public totalSupply = 9000000000000000000000000; // 9000000 tokens
    ...
    {  
        _mint(address(testAddress), totalSupply);
    }
