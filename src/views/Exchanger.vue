      ...
      <div v-if="isModal" class="modal">
        ...
        <div id="modal">
          ...
          <div v-if="isBuyModal">
            ...
            <div v-if="isNotEnoughBalanceDAI">
              <button id="button-modal-disabled">Insufficient balance</button>
            </div>
            <div v-else-if="isBuying">
...
export default {
  ...
  computed:
  {
    ...
    getDAIBalance()
    {
      return Number(this.balanceDAI).toString()
    },
    isEnoughBalance()
    {
    ...
    isNotEnoughBalanceDAI(){
      if(Number(this.getDAIBalance) < Number(this.getCostBuy))
      {
        return true
      }
      else return false
